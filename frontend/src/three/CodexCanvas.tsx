...
import { DocumentPipeline3D } from './DocumentPipeline3D';
  ...
  return (
    <div className="flex h-full w-full items-center justify-center">
      <div className="relative h-56 w-56">
        <div className="absolute inset-0 animate-[spin_18s_linear_infinite] rounded-full border border-amber-500/30" />
        <div className="absolute inset-6 animate-[spin_12s_linear_infinite_reverse] rounded-full border border-gold-400/25" />
        <div className="absolute inset-16 rounded-full bg-amber-500/20 blur-2xl" />
        <div className="absolute inset-0 flex items-center justify-center">
          <p className="max-w-[12rem] text-center text-xs text-ink-400">
            3D rendering is unavailable in this browser. The RAG pipeline still works.
          </p>
        </div>
      </div>
    </div>
